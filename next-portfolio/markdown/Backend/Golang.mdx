...
```go
func main() {
	// Declear slice1 is an array, default values are 1, 2, 3; length = 3
	slice1 := []int{1, 2, 3}

	// Declear slice2 is an array, but no space is allocated for slice2
	var slice2 []int
	// Allocate 3 * 8 bytes, default value: 0
	slice2 = make([]int, 3)

	// Declear slice3 is an array, allocate 3 * 8 bytes, default value: 0
	var slice3 []int = make([]int, 3)

	// Declear slice4 is an array, allocate 3 * 8 bytes, default value: 0
	slice4 := make([]int, 3)
