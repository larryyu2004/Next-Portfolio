...
- The best part: the SoundManager doesn’t constantly check anything. Instead, it just listens to events from different systems.
```CSharp
...
```
- Whenever the game detects something happening, it notifies the SoundManager.