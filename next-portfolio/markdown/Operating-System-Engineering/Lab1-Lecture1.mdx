...
3. Create a mirror image document: enter `docker import ubuntu.tar ubuntu` in the terminal.
...
8. Enter `ls` to see files in current root.
9. If you see sth like this -> Successfully build the environment!
...
4. Copy lab code into your own repository
5. Now, you can write code in the vsCode and use git pull in your Docker
---
## Docker
