...
const Education = () => {
  return (
    <>
      <div
        id="home-education"
        className="max-w-[785px] flex justify-center items-center min-h-[300px] p-[8px] mx-auto"
      >
        <div className="w-full relative flex justify-center items-center">
          ...
          <div className="absolute z-10 h-full flex flex-col items-end w-full">
            <h1 className="text-2xl md:text-4xl font-bold text-gray-600 dark:text-white">
              Adelaide University
            </h1>
